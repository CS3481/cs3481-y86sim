...
class FetchStage: public Stage
{
   private:
      ...
      void calcFStall(DecodeStage * dObj, E * ereg, uint64_t icode); 
      void calcDStall(DecodeStage * dObj, E * ereg, uint64_t icode);
      void calculateControlSignals(DecodeStage * dObj, E * ereg, uint64_t icode);
   public:
